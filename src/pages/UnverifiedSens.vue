...
<q-page padding>
 <div class="q-pa-md">
    <q-table
      ...
      no-data-label="You have no unverified Contributors"
    />
...
export default {
  ...
  created() {
    BossService.getUnverifiedSeniors().then(response=> {
  ...
  methods: {
   getStringsToVerify() {
    ...
    verify() {
      BossService.verifyManySeniors(this.getStringsToVerify())
        this.$q.notify({
